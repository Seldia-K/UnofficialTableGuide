...
リーフランプに繋がっていた場合、[アビス マルチボール](#D-アビス-マルチボール)の起動条件を進めることができます。  
...
エクストラボールは以下のタイミングでLIT状態になり、エクストラボールライトが点滅します。  
...
各ステージの対象のターゲットを全てヒットすることにより、次のステージへ進みます。  
...
このミッションを起動すると、下段フィールドの修復ポイントが1つ有効になり、青色に点灯します。  
...
マルチボール中に2つのダイブターゲット<sup>[t15](#t15-ダイブターゲット)</sup>を両方ヒットして、さらにシンクホールに切り替わったダイブターゲットにヒットすることで、ジャックポットのスコアを増やすことができます。  
...
1. リーフランプ<sup>[t8](#t8-リーフランプ)</sup>をヒットして、潜水艦にボールをロックする（新しいボールがプランジャーからオートシュートされる）
2. リーフランプ<sup>[t8](#t8-リーフランプ)</sup>を何度もヒットして、潜水艦を前進させる
3. 潜水艦がステーションまでたどり着くと、ボールがステーションに移される
4. もう一度潜水艦が待機状態になるので、1. ～3. を繰り返す
5. ボールをステーションに3つ移すとマルチボールが開始される
...
このマルチボール中は、左オービット<sup>[t2](#t2-左オービット)</sup>がシャークの口へ繋がります。  
シャークの口にヒットすることによりナイスショット ボーナススコアを貰えます。  

マルチボール終了までにシャークの口に **<ins>5</ins>** 回以上ヒットすると、マルチボールミッションを達成し、DEEPライトの1番目の'E'ライトが点灯します。  
...
マルチボール終了までに一定の条件を満たすことでマルチボールミッションを達成し、DEEPライトの2番目の'E'ライトが点灯します。  
...
今まで達成したプレイから条件を推測すると、「プローブクレーンに吊られているボールを計5回ヒットする」または「マルチボールのボールを増やすことに、初回含めて3回成功する」が有力です。特に後者の可能性が高いです。  
恐らく、「4ボールマルチボールにすること」が条件ではないと思われます。  
</details>
...
他のマルチボールと違い、同じレーンに連続でヒットしてもジャックポットを取得できます。  

マルチボール終了までに、上記のレーンに **<ins>5</ins>** 回以上ヒットするとマルチボールミッションを達成し、DEEPライトの'P'ライトが点灯します。  

## ウィザードモード

4種類全てのマルチボールミッションを達成すると起動できる最終ミッションです。  
